    ...
    <section className="hero-section-pixel">
      ...
      <div className="hero-container-inner">
        ...
        <h2 className="hero-role-subtitle">
          Ingénieur Machine Learning | Expertise MLOps & Fondateur MLAcademy.
        </h2>
        ...
        <div className="hero-social-row">
          {/* GitHub */}
          <a href="https://github.com/dona-eric" target="_blank" rel="noopener noreferrer" className="hero-social-circle" aria-label="GitHub">
          ...
          {/* LinkedIn */}
          <a href="https://linkedin.com/in/dona-erick" target="_blank" rel="noopener noreferrer" className="hero-social-circle" aria-label="LinkedIn">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
          ...
          {/* Twitter / X */}
          <a href="https://twitter.com/dona_erick" target="_blank" rel="noopener noreferrer" className="hero-social-circle" aria-label="Twitter">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
          ...
          {/* Instagram */}
          <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hero-social-circle" aria-label="Instagram">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {/* WhatsApp */}
          <a href="https://wa.me/+2290151344289" target="_blank" rel="noopener noreferrer" className="hero-social-circle" aria-label="WhatsApp">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
