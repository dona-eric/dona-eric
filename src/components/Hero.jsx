...
// ─── Social button avec label visible ─────────────────────────────────────────
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @keyframes orbit2    { from{transform:rotate(120deg) translateX(195px) rotate(-120deg)} to{transform:rotate(480deg) translateX(195px) rotate(-480deg)} }
        ...
        @media (max-width: 900px) {
          ...
          .desc-text  { margin: 0 auto !important; }
        }
      ...
      {/* Wrapper avec overflow-x:hidden pour bloquer le scroll horizontal */}
      <div style={{
        ...
        {/* ── Glow blobs — contraints pour ne pas déborder ── */}
        <div style={{
          position: "fixed", top: "5%", right: 0, width: "min(700px, 80vw)", height: "min(700px, 80vw)",
          background: "radial-gradient(circle, rgba(0,212,255,0.05) 0%, transparent 70%)",
          pointerEvents: "none", zIndex: 0
        }} />
        <div style={{
          position: "fixed", bottom: 0, left: 0, width: "min(600px, 70vw)", height: "min(600px, 70vw)",
        ...
        <div style={{
          ...
          <div className="hero-grid" style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
              ...
              {/* Status badge */}
              <div ref={badgeRef} className="badge-row" style={{
              ...
              <div ref={nameRef}>
                <div style={{
                  fontFamily: "'JetBrains Mono', monospace", fontSize: 11,
                  color: "#475569", letterSpacing: "0.15em", marginBottom: 10
                }}>
                  <span style={{ color: "#6366f1" }}>// </span>profile.init()
                </div>
                <h1 style={{
                  fontSize: "clamp(44px, 7.5vw, 88px)", fontWeight: 700,
              ...
              <div ref={roleRef} style={{
                fontSize: "clamp(18px, 2.8vw, 26px)", fontWeight: 600,
                fontFamily: "'JetBrains Mono', monospace", minHeight: 40
              }}>
                <RoleTypewriter />
              </div>

              {/* Description — terminal supprimé, texte seul */}
              <p ref={descRef} className="desc-text" style={{
                color: "#94a3b8", fontSize: 16, lineHeight: 1.85, maxWidth: 520
              }}>
              ...
              {/* Social links — avec labels visibles */}
              <div ref={socialRef} className="social-row" style={{
            ...
            <div ref={photoRef} className="photo-col" style={{
              ...
              {/* Photo frame — taille réduite sur mobile via clamp */}
              <div style={{
                position: "relative",
                ...
                <div style={{
                  ...
                  <div style={{
                    width: "100%", height: "100%", borderRadius: "50%",
                    background: "#0a0e17", padding: 5, overflow: "hidden"
                  }}>
                    <img
                      src="/eric.jpg"
          ...
          {/* ══ STATS ══ */}
          <div ref={statsRef} style={{ marginTop: 72 }}>
            <div style={{
            ...
            <div className="stats-grid" style={{
              ...
              {stats.map((s, i) => (
                <StatCard key={i} {...s} delay={1.3 + i * 0.1} />
              ))}
            </div>
          </div>
        </div>
