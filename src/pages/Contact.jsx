      ...
      <div style={{
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 1100, margin: "0 auto", padding: "80px 24px 120px" }}>
          ...
          <div style={{
            ...
            <MetricCard label="Projects Delivered" value="08+" sub="Diverse domains" delay={0.2} />
          ...
          >
            ...
            <div ref={infoRef} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div ref={socialRef} className="social-row" style={{ display:"flex", alignItems:"center", gap:10, flexWrap:"wrap" }}>
                ...
                />
                <SocialBtn href="https://www.facebook.com/dona.eric.koulodji" label="Facebook" color="#64748b"
                  icon={<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M10.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>}
                />
              </div>
            </div>
          </div>
